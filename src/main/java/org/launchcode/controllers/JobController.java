...
public class JobController {
    ...
    public String index(Model model, @RequestParam int id) {
        ...
        Job jobByInt = jobData.findById(id);
        model.addAttribute(jobByInt);
    ...
    public String add(Model model, @ModelAttribute @Valid JobForm jobForm, Errors errors) {
        ...
        CoreCompetency jobCoreCompetency = jobData.getCoreCompetencies().findById(3);
        Location jobLocation = jobData.getLocations().findById(3);
        PositionType jobPosition = jobData.getPositionTypes().findById(3);
